...
class InfoIncontinenciaActivity : AppCompatActivity() {

    private lateinit var btnVolverAtras: ImageButton
    private lateinit var btnPdf: Button
    private lateinit var txt_incontinencia: TextView

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_info_incontinencia)
        ...
        txt_incontinencia = findViewById(R.id.text_incontinencia_esperar)

        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.N) {
            txt_incontinencia.setText(Html.fromHtml(getString(R.string.text_incontinencia_esperar), Html.FROM_HTML_MODE_LEGACY));
        } else {
            txt_incontinencia.setText(Html.fromHtml(getString(R.string.text_incontinencia_esperar)));
        }
    ...
    private fun downloadPdf() {
        val assetFileName = "INCONTINENCIA FECAL.pdf"
        try {

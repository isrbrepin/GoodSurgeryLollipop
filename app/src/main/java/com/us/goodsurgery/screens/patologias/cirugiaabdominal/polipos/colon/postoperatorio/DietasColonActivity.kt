...
import com.us.goodsurgery.screens.patologias.cirugiaabdominal.reconstruccion.ileostomia.postoperatorio.DietaInviernoIleostomiaActivity
import com.us.goodsurgery.screens.patologias.cirugiaabdominal.reconstruccion.ileostomia.postoperatorio.DietasAltaIleostomiaActivity

class DietasColonActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_dietas_colon)
        ...
        btnDietaVerano.setOnClickListener{
            intent = Intent(this, DietaVeranoColonActivity::class.java)
            startActivity(intent)
        }

        btnDietaInvierno = findViewById(R.id.btn_dieta_invierno)
        btnDietaInvierno.setOnClickListener{
            intent = Intent(this, DietaInviernoColonActivity::class.java)
            startActivity(intent)
        }
    }
}
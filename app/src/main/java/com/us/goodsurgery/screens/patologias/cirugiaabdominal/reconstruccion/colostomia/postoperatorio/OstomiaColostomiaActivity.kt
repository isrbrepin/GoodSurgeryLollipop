...
class OstomiaColostomiaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.N) {
            ostomia1.setText(Html.fromHtml(getString(R.string.text_ostomia1), Html.FROM_HTML_MODE_LEGACY));
        } else {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.N) {
            ostomia2.setText(Html.fromHtml(getString(R.string.text_ostomia2), Html.FROM_HTML_MODE_LEGACY));
        } else {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.N) {
            ostomia3.setText(Html.fromHtml(getString(R.string.text_ostomia3), Html.FROM_HTML_MODE_LEGACY));
        } else {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.N) {
            ostomia4.setText(Html.fromHtml(getString(R.string.text_ostomia4), Html.FROM_HTML_MODE_LEGACY));
        } else {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.N) {
            ostomia5.setText(Html.fromHtml(getString(R.string.text_ostomia5), Html.FROM_HTML_MODE_LEGACY));
        } else {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.N) {
            ostomia6.setText(Html.fromHtml(getString(R.string.text_ostomia6), Html.FROM_HTML_MODE_LEGACY));
        } else {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.N) {
            ostomia7.setText(Html.fromHtml(getString(R.string.text_ostomia7), Html.FROM_HTML_MODE_LEGACY));
        } else {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.N) {
            ostomia8.setText(Html.fromHtml(getString(R.string.text_ostomia8), Html.FROM_HTML_MODE_LEGACY));
        } else {

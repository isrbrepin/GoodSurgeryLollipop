...
class PreparacionColostomiaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.N) {
            info_preo_recons1.setText(
                Html.fromHtml(
                    getString(R.string.text_texto_preo_recons),
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.N) {
            info_preo_recons2.setText(
                Html.fromHtml(
                    getString(R.string.text_texto_preo_recos_lista1),
                    Html.FROM_HTML_MODE_LEGACY
                )
            );
        } else {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.N) {
            info_preo_recons3.setText(
                Html.fromHtml(
                    getString(R.string.text_texto_preo_recons_lista2),
                    Html.FROM_HTML_MODE_LEGACY
                )
            );
        } else {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.N) {
            info_preo_recons4.setText(
                Html.fromHtml(
                    getString(R.string.text_texto_preo_recons_lista3),
                    Html.FROM_HTML_MODE_LEGACY
                )
            );
        } else {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.N) {
            info_preo_recons5.setText(
                Html.fromHtml(
                    getString(R.string.text_texto_preo_recons_lista4),
                    Html.FROM_HTML_MODE_LEGACY
                )
            );
        } else {

...
class InfoProlapsoActivity : AppCompatActivity() {

    private lateinit var btnVolverAtras: ImageButton
    private lateinit var btnPdf: Button
    private lateinit var txt_prolapso1: TextView
    private lateinit var txt_prolapso2: TextView

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_info_prolapso)
        ...
        btnPdf.setOnClickListener(View.OnClickListener {
            ...
            val assetFileName = "PROLAPSO RECTO.pdf"
        ...
        txt_prolapso1 = findViewById(R.id.textInfoProlapso1)

        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.N) {
            txt_prolapso1.setText(Html.fromHtml(getString(R.string.textInfoProlapso1), Html.FROM_HTML_MODE_LEGACY));
        } else {
            txt_prolapso1.setText(Html.fromHtml(getString(R.string.textInfoProlapso1)));
        }

        // Lógica para permitir que se use el texto en html para poner negritas y rayadas por ejemplo

        txt_prolapso2 = findViewById(R.id.textInfoProlapso2)

        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.N) {
            txt_prolapso2.setText(Html.fromHtml(getString(R.string.textInfoProlapso2), Html.FROM_HTML_MODE_LEGACY));
        } else {
            txt_prolapso2.setText(Html.fromHtml(getString(R.string.textInfoProlapso2)));
        }

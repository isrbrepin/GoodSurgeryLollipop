package com.us.goodsurgery.screens.patologias.cirugiaabdominal.inflamatoria.crohn
...
class InfoReseccionActivity : AppCompatActivity() {

    private lateinit var btnVolverAtras: ImageButton
    private lateinit var btnPdf: Button
    private lateinit var txt_crohn: TextView
    private lateinit var txt_crohn2: TextView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_info_reseccion)
...
// Lógica para permitir que se use el texto en html para poner negritas y rayadas por ejemplo
        ...
        txt_crohn = findViewById(R.id.text_crohn1)

        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.N) {
            txt_crohn.setText(Html.fromHtml(getString(R.string.text_crohn1), Html.FROM_HTML_MODE_LEGACY));
        } else {
            txt_crohn.setText(Html.fromHtml(getString(R.string.text_crohn1)));
        }

        txt_crohn2 = findViewById(R.id.text_crohn2)

        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.N) {
            txt_crohn2.setText(Html.fromHtml(getString(R.string.text_crohn2), Html.FROM_HTML_MODE_LEGACY));
        } else {
            txt_crohn2.setText(Html.fromHtml(getString(R.string.text_crohn2)));
        }
    ...
    private fun downloadPdf() {
        val assetFileName = "ENFERMEDAD DE CROHN.pdf"
        try {

...
class PreparacionFistulaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_preparacion_fistula)
    ...
    private fun downloadPdf() {
        ...
        val assetFileName = "Indicaciones preOP de Proctologia.pdf"

package com.us.goodsurgery.screens.patologias.suelopelvico.prolapso.postoperatorio
...
class AltaProlapsoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_alta_prolapso)
    ...
    private fun downloadPdf() {
        val assetFileName = "Indicaciones al ALTA SUELO PELVICO.pdf"
        try {

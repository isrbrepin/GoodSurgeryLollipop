...
class IngresoHemorroidesActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_ingreso_hemorroides)
        ...
        btnPdf.setOnClickListener(View.OnClickListener {
            ...
            val assetFileName = "Instrucciones para el INGRESO _ CMA.pdf"

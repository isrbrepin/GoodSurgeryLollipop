...
class PreoperatorioFistulaActivity : AppCompatActivity() {
    ...
    fun openAnestesiaActivity(view: View) {
        val intent = Intent(this, AnestesiaFistulaActivity::class.java)
        startActivity(intent)
    }
    fun openIngresoActivity(view: View) {
        val intent = Intent(this, IngresoFistulaActivity::class.java)
        startActivity(intent)
    }
    fun openPreparacionActivity(view: View) {
        val intent = Intent(this, PreparacionFistulaActivity::class.java)
        startActivity(intent)
    }
    fun openHospitalActivity(view: View) {
        val intent = Intent(this, HospitalFistulaActivity::class.java)
        startActivity(intent)
    }
}